...
class NativeReference:
    ...
    @classmethod
    def build(cls, scaffold_id, ref_pdb, apo_pdb, holo_pdb, distal_idx, chains=None, metadata=None):
        ...
        return cls(mapping, resp, conf, dm, metadata)
    ...
    def save(self, out_dir):
        ...
        json.dump({"scaffold_id": self.mapping.scaffold_id, "channels": CHANNELS, **self.metadata},
